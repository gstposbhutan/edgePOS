...
import { ArrowLeft, XCircle, RefreshCw, RotateCcw, Loader2, Receipt } from "lucide-react"
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          ...
          <div className="p-3 rounded-lg border border-border bg-card space-y-1">
            ...
            <p className="text-xs text-muted-foreground">{order.buyer_whatsapp ?? 'Face-ID'}</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            {items.map(item => (
              <div key={item.id} className="flex items-center gap-3 p-2.5 rounded-lg border border-border bg-card">
                <div className="flex-1 min-w-0">
