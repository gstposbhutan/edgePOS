...
- **Phase 1 — B2B selling + actionable orders:** seller-initiated order/invoice to a linked buyer; make incoming orders actionable (confirm/dispatch/cancel-with-stock-return/refund); SO/Quotation + SO→SI convert in the console.
