...
// Business accounts are set up by the Pelbu team (meeting D7 — no self-service shop
// creation), so every plan CTA routes to the contact form.
const PLANS = [
  { icon: Store, role: 'Retailer', body: 'Run the counter, sell online, and stay GST-compliant.', href: '/contact', cta: 'Open a retail shop' },
  { icon: Building2, role: 'Wholesaler', body: 'Supply retailers, manage credit and warehouse stock.', href: '/contact', cta: 'Wholesaler account' },
  { icon: Truck, role: 'Distributor', body: 'Move goods across the tier with bulk packages and B2B ordering.', href: '/contact', cta: 'Distributor account' },
]

const STEPS = [
  { n: '1', title: 'Get your account', body: 'Tell us about your business and we set up your shop — usually the same day.' },
  ...
  return (
    <>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border">
          ...
          <div className="relative max-w-xl px-6 py-16 sm:px-12 sm:py-24">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/contact"><Button size="lg">Open a shop</Button></Link>
              <Link href="/contact">
      ...
      <CtaBand
        ...
        body="Get set up today — no credit card, no lock-in. Sell in-store and online from one place."
