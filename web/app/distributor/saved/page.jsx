...
import { EntityBrowser } from '@/components/console/entity-browser'

export default function DistributorSavedPage() {
  ...
  return (
    <ConsoleShell title="Distributor Console" name={name} nav={distributorNav()} active="saved">
      <EntityBrowser
        mode="saved"
        title="Saved"
        subtitle="Wholesalers and retailers you've starred"
      />
    </ConsoleShell>
  )
}
