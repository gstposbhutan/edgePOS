...
import { WarehouseManager } from '@/components/console/warehouse-manager'

export default function DistributorWarehousesPage() {
  ...
  return (
    <ConsoleShell title="Distributor Console" name={name} nav={distributorNav()} active="warehouses">
      <WarehouseManager />
    </ConsoleShell>
  )
}
