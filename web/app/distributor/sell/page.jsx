...
import { SellToBuyer } from '@/components/console/sell-to-buyer'

export default function DistributorSellPage() {
  ...
  return (
    <ConsoleShell title="Distributor Console" name={name} nav={distributorNav()} active="sell">
      <SellToBuyer />
    </ConsoleShell>
  )
}
