...
import { KhataManager } from '@/components/console/khata-manager'

export default function DistributorKhataPage() {
  ...
  return (
    <ConsoleShell title="Distributor Console" name={name} nav={distributorNav()} active="khata">
      <KhataManager />
    </ConsoleShell>
  )
}
