...
import { PurchaseManager } from '@/components/console/purchase-manager'

export default function DistributorPurchasesPage() {
  ...
  return (
    <ConsoleShell title="Distributor Console" name={name} nav={distributorNav()} active="purchases">
      <PurchaseManager />
    </ConsoleShell>
  )
}
