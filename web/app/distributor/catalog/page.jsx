...
import { VendorCatalog } from '@/components/console/vendor-catalog'
...
export default function DistributorCatalogPage() {
  ...
  return (
    <ConsoleShell title="Distributor Console" name={name} nav={distributorNav()} active="catalog">
      <VendorCatalog role="DISTRIBUTOR" />
    </ConsoleShell>
  )
}
