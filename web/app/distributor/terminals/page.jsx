...
import { TerminalsManager } from '@/components/console/terminals-manager'

export default function DistributorTerminalsPage() {
  ...
  return (
    <ConsoleShell title="Distributor Console" name={name} nav={distributorNav()} active="terminals">
      <TerminalsManager />
    </ConsoleShell>
  )
}
