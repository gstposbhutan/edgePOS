...
import { DistributorRestock } from '@/components/console/distributor-restock'

export default function WholesalerRestockPage() {
  ...
  return (
    <ConsoleShell title="Wholesaler Console" name={name} nav={wholesalerNav()} active="restock">
      <DistributorRestock />
    </ConsoleShell>
  )
}
