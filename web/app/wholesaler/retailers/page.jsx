...
export default function WholesalerRetailersPage() {
  ...
  return (
    <ConsoleShell title="Wholesaler Console" name={name} nav={wholesalerNav()} active="retailers">
      <EntityBrowser
        mode="browse"
        targetRole="RETAILER"
        title="Retailers"
        subtitle="Browse every active retailer · connect the ones you supply, star the rest"
      />
    </ConsoleShell>
  )
}
