        ...
        <div className="space-y-4">
          ...
          <label className="flex items-center gap-2 text-sm cursor-pointer">
            <input
              ...
              onChange={(e) => setForm((prev) => ({ ...prev, sold_by_weight: e.target.checked }))}
              className="h-4 w-4"
            />
            <span>
              Sold by weight / measure
              <span className="text-muted-foreground"> — selling price is the per-{form.unit} rate; cashier enters a {form.unit} amount at checkout</span>
            </span>
          </label>
