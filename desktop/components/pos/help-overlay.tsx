...
const GROUPS: { title: string; stub?: boolean; shortcuts: { key: string; action: string }[] }[] = [
  {
    ...
    shortcuts: [
      ...
      { key: "F8", action: "Sales person" },
      { key: "Ctrl+C", action: "Complimentary (manager)" },
      { key: "Ctrl+E", action: "Exchange / return" },
      { key: "Alt+Q", action: "Save as quotation" },
      { key: "Alt+M", action: "Post to market" },
      { key: "Alt+D", action: "Delivery address" },
    ],
  },
];
