...
export const COUNTER_KEYS: KeyEntry[] = [
  ...
  { id: "print",        combo: "Ctrl+P", match: { key: "p", ctrl: true },      label: "Print",                    group: "Ticket", todo: true },
  { id: "lastGst",      combo: "PgUp",   match: { key: "PageUp" },             label: "Last GST",                 group: "Ticket", todo: true },
