...
function createWindow() {
  ...
  // F11, but the inherited map the counter now follows gives F11 to Day (day-end), and shops
  // coming from the incumbent ERP press it expecting that — so fullscreen moved to the other
